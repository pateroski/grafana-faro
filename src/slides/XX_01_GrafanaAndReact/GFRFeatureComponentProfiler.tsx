  ...
  return (
    <>
      ...
      `}
        ...
        <Notes>
          <li>
            El Component Profiler captura la duración de la renderización y el montaje de
            componentes, permitiendo medir el rendimiento de renderizado de un árbol de React
            mediante código.
          </li>
          <li>
            La creación de perfiles agrega cierta sobrecarga adicional, por lo que está
            deshabilitada en la compilación de producción de forma predeterminada.
          </li>
        </Notes>
      </Slide>
    </>
