    ...
    <Slide backgroundImage={`url(${Back})`}>
      ...
      <Notes>
        <li>
          ...
          JavaScript, pero para componentes. Sólo capturan errores en los componentes bajo ellos en
          el árbol y si fallan tratando de renderizar el mensaje de error, el error se propagará al
          límite de errores más cercano por encima de él.
        </li>
        <li>
          En el caso de React Faro envía el seguimiento del stack de errores no controlados en esos
          componentes y los registra en Grafana. Detecta los errores y mantiene el árbol de
